static const char *introTextData =
	...
	"\n"
	"\boAdded Elements:\n"
	"\bgRADN (Radon), ENZM (Enzyme), LITH (Lithium), BOLT (Unstable gas), SOIL, MUD, SEED, MGSM (Magnesium),\n"
	"MGMP (Magnesium powder), SSTN (Sandstone), ANT (Langton's Ant), BASE, ROFL, PLST (Plastic),\n"
	"OTWR (One time wire), PLDM (Palladium), FLSH (Flash powder), BULB, RVRS (Reversium), GRVT (Gravitons)\n"
	"\n"
	"\boOther changes:\n"
	"\bg- A few minor changes (SPRK is less glowy, WIFI breaks at higher pressure...)\n"
	...
	"Any suggestion is welcome, detailed / already done things are prefered to be added.\n"
	"\n"
