static const char *introTextData =
	"\blThe Powder Toy (nucular's mod) - Version " MTOS(SAVE_VERSION) "." MTOS(MINOR_VERSION) " - http://powdertoy.co.uk, irc.freenode.net #powder\n"
	...
	"\n"
    "Mod created by: \bgnucular (\blhttp://tpt.io/@nucular\bg)\n"
    "\n"
